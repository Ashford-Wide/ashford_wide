...
- **Style** — dashed red lines (`color: #A72326`, `weight: 7`, `opacity: 0.85`, `dashArray: '10, 10'`) to indicate a closure. `#A72326` is the same red used for the `[!CAUTION]` alert accent colour (see [docs/technical/tailwind.md](tailwind.md)).
