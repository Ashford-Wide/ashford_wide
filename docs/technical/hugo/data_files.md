...
> [!NOTE]
> These fields are edited by content editors through Sveltia CMS "files" collections, not just by developers. See [docs/editorial/cms_collections.md](../../editorial/cms_collections.md) for which collection maps to which file.
...
Each person is rendered with Schema.org `Person` microdata — see [docs/technical/seo.md](../seo.md#team-microdata).
