...
|---|---|---|
| `npm run test:a11y` | `hugo && node scripts/a11y-test.mjs` | Builds the site, then runs WCAG 2.2 AA accessibility checks — see [docs/technical/accessibility_testing.md](../accessibility_testing.md) |
