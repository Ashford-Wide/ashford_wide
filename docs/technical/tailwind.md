...
**Alert callouts** (rendered from `> [!NOTE]`-style blockquotes in markdown, see [docs/editorial/markdown_shortcodes.md](../editorial/markdown_shortcodes.md)) are styled within `.article-content`:
